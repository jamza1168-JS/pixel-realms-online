...
const I18N = {
  en: {
    ...
    'inv.cancel': 'Cancel',
    'inv.refineBtn': '⚒ Refine +{r} ({g}🪙 {o}🪨)',
    'inv.refineMaxTag': 'MAX',
    'inv.refineMax': 'Already at maximum refine (+9)',
    ...
    'gear.book': 'Tome',
    'gear.quiver': 'Quiver',
    'inv.classOnly': '🔒 {c} only',
    'equip.wrongClass': "Your class can't use that item.",
    'equip.needsOneHand': 'Needs a one-hand weapon to pair an off-hand.',
    'equip.needsWeapon': 'That off-hand needs its matching weapon equipped.',
  ...
  th: {
    ...
    'inv.cancel': 'ยกเลิก',
    'inv.refineBtn': '⚒ ตีบวก +{r} ({g}🪙 {o}🪨)',
    'inv.refineMaxTag': 'สูงสุด',
    'inv.refineMax': 'ตีบวกถึงระดับสูงสุดแล้ว (+9)',
    ...
    'gear.shield': 'โล่',
    'gear.book': 'ตำรา',
    'gear.quiver': 'กระบอกธนู',
    'inv.classOnly': '🔒 เฉพาะ {c}',
    'equip.wrongClass': 'อาชีพของคุณใช้ไอเทมนี้ไม่ได้',
    'equip.needsOneHand': 'ต้องใช้อาวุธมือเดียวจึงจะถือมือรองได้',
    'equip.needsWeapon': 'มือรองนี้ต้องใช้คู่กับอาวุธที่ตรงกัน',
