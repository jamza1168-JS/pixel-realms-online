...
const SPRITE_DEFS = {
  ...
  /* ---- New content for future systems (not yet spawned; see ENEMY_TYPES
     and docs/ART_REDESIGN.md). All 16x16 to match the existing set. ---- */
  orc: {
    rows: [
      '................',
      '................',
    ...
    palette: { g:'#24401f', G:'#6fae4f', w:'#f0f0d0', b:'#5a3a24', B:'#8a6a44', o:'#241a12', '.':null },
  },
  ghost: {
    rows: [
      '................',
    ...
    palette: { w:'#dfefff', e:'#33384a', '.':null },
  },
  ogre: {
    rows: [
      '................',
    ...
    palette: { g:'#3a5a24', G:'#7fae4f', w:'#f0f0d0', b:'#4a2f1a', B:'#93c25f', '.':null },
  },
  dragon: {
    rows: [
      '................',
    ...
    palette: { r:'#b0342f', R:'#e0705a', D:'#7a1f1c', w:'#4a1210', e:'#ffd000', '.':null },
  },
  portal: {
    rows: [
      '................',
